...
**macula-tweann** is a Topology and Weight Evolving Artificial Neural Networks library for Erlang, based on DXNN2 by Gene Sher ("Handbook of Neuroevolution through Erlang").
...
3. Bump version in `src/macula_tweann.app.src`
