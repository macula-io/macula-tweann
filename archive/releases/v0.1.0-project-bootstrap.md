...
This release establishes the foundation for the macula-tweann refactoring effort. It creates the test infrastructure, sets up static analysis tools, and defines core type specifications that will be used throughout the project.
