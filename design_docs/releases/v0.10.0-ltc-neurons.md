...
This release introduces **Liquid Time-Constant (LTC) neurons** to macula-tweann, making it the first TWEANN library with LTC/CfC neuron support in Erlang/OTP. LTC neurons enable adaptive temporal processing with input-dependent time constants.
